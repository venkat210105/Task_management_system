const inputClass =
  'rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500';
...
export default function FilterBar({ filters, onChange, onNewTask }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 mb-4">
      ...
      <button
        onClick={onNewTask}
        className="ml-auto bg-amber-500 hover:bg-amber-600 text-gray-900 text-sm font-semibold rounded-md px-4 py-2 transition"
      >
        + New Task
      </button>
    </div>
